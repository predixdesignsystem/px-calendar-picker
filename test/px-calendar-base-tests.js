...
function runBaseTests() {
  px_calendar_1 = document.getElementById('px_calendar_1');

  suite('Base Automation Tests for px-calendar', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-calendar fixture is created', function() {
      assert.isTrue(document.getElementById('px_calendar_1') !== null);
    });
